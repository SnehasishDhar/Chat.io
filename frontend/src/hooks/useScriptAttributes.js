...
const DEFAULT_SETTINGS = {
  ...
  sponsorText: "Powered by Chat.io", // default sponsor text
  sponsorLink: "https://chat.io", // default sponsor link
  position: "bottom-right", // position of chat button/window
  assistantName: "Chat.io Chat Assistant", // default assistant name
  ...
  useEffect(() => {
    function fetchAttribs() {
      ...
      if (
        ...
        throw new Error(
          "[Chat.io Embed Module::Abort] - Invalid script tag setup detected. Missing required parameters for boot!"
        );
